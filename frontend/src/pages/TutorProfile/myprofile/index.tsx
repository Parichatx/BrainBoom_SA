...
function MyProfile() {
  ...
  // Check if coming back from EditTutor and refresh data
  useEffect(() => {
    ...
    <>
      ...
      <Row style={{ height: '100vh', backgroundColor: '#FFFFFF', margin: 0 }}>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px' }}>
          <Card className="card-profile" style={{ width: '100%', maxWidth: 1400, height: 'auto', border: 'none', padding: '20px', boxShadow: '0 2px 8px rgba(0, 0, 0, 0.15)' }}>
            <Row gutter={[16, 24]} justify="center">
              <Col xs={24} sm={12} md={8} lg={6} xl={4}>
                <img
                  ...
                  alt="Profile"
                  className="pic2"
                  style={{ width: '100%', height: 'auto', maxHeight: '100%', marginBottom: '20px' }}
                />
              </Col>
            </Row>
            <div style={{ textAlign: 'center' }}>
              ...
              <p><strong>ประวัติย่อ:</strong> {profileData?.Bio}</p>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap', marginTop: '20px' }}>
              <Button
                style={{ width: 'calc(50% - 10px)' }}
                onClick={() => navigate(`/tutor_profiles/edit/${UserID}`, { state: { fromEdit: true } })}
              >
